...
The slides can be found here: https://sfnetworks.github.io/useR2021/slides

The code to create them can be found here: https://github.com/sfnetworks/useR2021
...
Nodes and edges embedded in geographical space
...
ggplot() +
  ...
  geom_sf(data = st_as_sf(net, "nodes"), aes(size = betweenness)) +
  ggtitle("Betweenness centrality")
```
]
